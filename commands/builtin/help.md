...
| `list_issues` | User asks what's tracked → load /terminal_hub:issues for interactive browser |
...
- When a tool response contains `_display`, render that field verbatim to the user instead of summarising the raw JSON.
